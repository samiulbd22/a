...
const members = {
    ...
    "01814843266":{
        ...
        post_payable        :2966,
        previous_paid       :5500,
        previous_dining_cost:2368,
        payment             :{"16/04/25-Ca/Bksh":4500},
    ...
    "01922362569":{
        ...
        post_payable        :2997,
        previous_paid       :5500,
        previous_dining_cost:3360,
        payment             :{"10/04/25-Cash":2000,"19/04/25-DBBL":500,"22/04/25-DBBL":500,
			      "24/04/25-DBBL":500,"26/04/25-DBBL":500,,"27/04/25-DBBL":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
    ...
    "01797816501":{
        ...
        post_payable        :3600,
        previous_paid       :6300,
        previous_dining_cost:2960,
        payment             :{"07/04/25-Cash":5000,"16/04/25-Cash":500},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
    ...
    "01707474654":{
        ...
        payment             :{"15/04/25-Cash":3000,"22/04/25-Cash":1500},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :3100,
        running_paid    :4500,
        running_meal    :31,
        // method calling
        preMonth,
    ...
    "01537664564":{
        ...
        payment             :{"05/04/25-Cash":3500,"19/04/25-Cash":2000,"25/04/25-Cash":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
    ...
    "01921567438":{
        ...
        previous_paid       :3500,
        previous_dining_cost:0,
        payment             :{"15/04/25-Cash":3500,"17/04/25-Cash":1500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :3500,
        running_paid    :5000,
        running_meal    :35,
        // method calling
        preMonth,
    ...
    "01934147404":{
        ...
        previous_paid       :3500,
        previous_dining_cost:0,
        payment             :{"15/04/25-Cash":3500,"17/04/25-Cash":1500,"27/04/25-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :3500,
    ...
    "01874857679":{
        ...
        payment             :{"12/04/25-Cash":5000,"26/04/25-Cash":1000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
	...
	"01821245430":{
        ...
        post_payable        :-304,
        previous_paid       :3500,
        previous_dining_cost:3774,
        payment             :{"12/04/25-Cash":1500,"15/04/25-Cash":500,"22/04/25-Cash":400},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :0,
